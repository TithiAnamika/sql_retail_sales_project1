...
-- Q.2 Write a SQL query to retrive all transactions where the category is 'Clothing' and the quantity sold is more than 
-- 10 in the month on Nov - 2022

SELECT category, SUM(quantity) FROM retail_sales WHERE category = 'Clothing' Group By 1
...
-- Q.10 Write a SQL query to create each shift and number of orders (EG: Morning <= 12, Afternoon Between 12 & 17, Evening > 17)
 ...
 SELECT *,
 CASE 
 WHEN EXTRACT (HOUR FROM sale_time) < 12 THEN 'Mornning'
